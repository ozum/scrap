...
@fortibase/scrap/0.0.52 darwin-x64 node-v12.4.0
$ scrap --help [COMMAND]
USAGE
  $ scrap COMMAND
...
...
_See code: [dist/commands/uninstall.js](https://github.com/ozum/scrap/blob/v0.0.52/dist/commands/uninstall.js)_
...
_See code: [dist/commands/update.js](https://github.com/ozum/scrap/blob/v0.0.52/dist/commands/update.js)_
